...
description: "A step-by-step guide to add updated at to existing Eleventy blog using spec-driven development with AWS Kiro"
...
<img class="center" src="/images/aws-kiro/01aws-kiro.jpg" title="How to use spec-driven development on AWS Kiro to add updated at to an Eleventy blog" alt="How to use spec-driven development on AWS Kiro to add updated at to an Eleventy blog" fetchpriority="high">
...
- [Adding updated at to an Eleventy blog](#adding-updated-at-to-an-eleventy-blog)
  ...
  - [Kiro creates the required docs and tasks](#kiro-creates-the-required-docs-and-tasks)
...
<img class="center" src="/images/aws-kiro/02updated-at.jpg" loading="lazy" title="The updated at feature to be developed with AWS Kiro using spec-driven development" alt="The updated at feature to be developed with AWS Kiro using spec-driven development">
...
<img class="center" src="/images/aws-kiro/04aws-kiro-intial-sdd-prompt.jpg" loading="lazy" title="AWS Kiro with the initial prompt for the updated at feature for the Eleventy blog" alt="AWS Kiro with the initial prompt for the updated at feature for the Eleventy blog">
...
### Kiro creates the required docs and tasks
...
<img class="center" src="/images/aws-kiro/07aws-kiro-requirements.jpg" loading="lazy" title="AWS Kiro wrote the requirements" alt="AWS Kiro wrote the requirements">
...
<img class="center" src="/images/aws-kiro/08aws-kiro-design-doc.jpg" loading="lazy" title="AWS Kiro writing the design doc" alt="AWS Kiro writing the design doc">
...
<img class="center" src="/images/aws-kiro/13aws-kiro-follow-task.jpg" loading="lazy" title="Asking AWS Kiro to follow the currently running task" alt="Asking AWS Kiro to follow the currently running task">
