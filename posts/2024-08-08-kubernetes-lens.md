...
description: "Kubernetes Lens is the missing tool in your K8s arsenal; in this post, learn about its features and how to use it."
...
Before you delve into the specifics of Kubernetes Lens, let's take a trip down memory lane and look at some of the tools I have used to work with Kubernetes before using Lens. It will also give you a better idea of how things have evolved in the past few years. I have used Kubernetes Lens for more than 2 years now, but before using Kubernetes Lens, I had used other tools like:
...
There are many features you will like about Lens Kubernetes, please explore it and find the ones you will admire. You can have a look at secrets, replica sets, Horizontal Pod Autoscalers (HPA) and many other Kubernetes artifacts.
