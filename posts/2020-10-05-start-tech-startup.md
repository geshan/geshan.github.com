...
1. You will need to register for a new GCP account and bag your [$300 credit](https://cloud.google.com/free) that should be used by 3 months.
...
2. Trello / Asana - Depending on your project/product management flavor you can use [Trello](https://trello.com/) or [Asana](https://asana.com/) free version to manage your product development.
3. CodeClimate - To keep a tab on the health of your code you can use CodeClimate [free plan](https://codeclimate.com/quality/pricing/) with 4 seats. This will be a boon for your tech startup’s code quality.
4. ForwardEmail - Great you have your domain but using a Gmail email won’t work best for your brand identity. Get your info@yourdomain.ml for free with [ForwardEmail](https://forwardemail.net/en) free plan.
5. Free CDN - If you are serving images or static assets on your website or web application you can use [Statically](https://statically.io/) to get the CDN optimizations and benefits. Try it, it is free and unlimited too.
