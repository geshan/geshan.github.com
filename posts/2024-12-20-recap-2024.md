...
Regarding ranking, this blog moved from the 882,178th website in the world in 2023 to the 590,709th position in 2024 on [SimilarWeb](https://www.similarweb.com/website/geshan.com.np/) as seen below:

<img class="center" src="/images/recap-2024/03blog-similar-web-2024.jpg" loading="lazy" title="Blog ranking in the world at the end of 2024 as per SimilarWeb" alt="Blog ranking in the world at the end of 2024 as per SimilarWeb">
...
I was fortunate enough to be a guest on two podcasts. First, the popular StackOverflow Podcast titled [From PHP to JavaScript to Kubernetes: how one backend engineer evolved over time](https://stackoverflow.blog/2024/08/23/evolution-backend-engineering-php-javascript-kubernetes-containers/). I had emailed them and got a reply back, and had a quick pre-recording chat with Ryan. Then, the recording happened on an early Saturday morning (late Friday afternoon in the New York time zone); after some weeks, it was published and has had thousands of listeners so far. You can also listen to our conversation below:
...
In addition to being a Google Developer Expert (GDE) for Google Cloud since 2019, I wanted to be tagged with another [developer ambassador program](https://github.com/geshan/developer-ambassador-programs). I emailed Docker to apply to become a Docker Captain in 2021 and 2023 but never heard back. This year, they added a form to become a Docker Captain, and thankfully, Eva replied when I filled out the form. She organized a short interview (chat) and approved my application, and I became a [Docker Captain](https://www.docker.com/captains/geshan-manandhar/) in late June of this year. When writing this, there are only three Docker Captains in Australia.
...
I have started an open-source repository to list the [developer ambassador programs](https://github.com/geshan/developer-ambassador-programs) I know about. There are 40+ developer ambassador programs listed in the repo; eight are `students only` programs. Some popular ones are AWS Community Builder, GitHub Campus Expert, Google Cloud Innovator Champion, and Microsoft MVP.
