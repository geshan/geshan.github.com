...
updated: 2026-06-15T12:00:00.000+10:00
comments: true
tags:
- Google AI Studio
- AI
...
keywords: google ai studio database, google ai studio full stack, google ai studio next js, google ai studio firebase, google ai studio firestore
---
...
Now that these are mentioned, you can start building a login and user profile page on Google AI Studio by prompting (and vibe coding) in place of writing code to integrate with Firebase next. 
...
You could have used [Google Stitch to vibe-design](https://blog.google/innovation-and-ai/models-and-research/google-labs/stitch-ai-ui-design/) it, and we can keep it as a topic for another blog post. 
...
On this page, click the settings gear ⚙️ on the top right:
...
<img class="center" src="/images/google-ai-studio-database/06gias-generating-app.jpg" loading="lazy" title="Google AI Studio generating the profile page app" alt="Google AI Studio generating the profile page app">
...
<img class="center" src="/images/google-ai-studio-database/07gias-firebase-perms.jpg" loading="lazy" title="Google AI Studio generating the profile page app and enabling Firebase" alt="Google AI Studio generating the profile page app and enabling Firebase">
...
<img class="center" src="/images/google-ai-studio-database/13data-in-firestore.jpg" loading="lazy" title="Profile page app generated by Google AI Studio verified that data is saved correctly in Firebase Firestore" alt="Profile page app generated by Google AI Studio verified that data is saved correctly in Firebase Firestore">
