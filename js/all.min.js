...
if (scrollDiv && leftBtn && rightBtn) {
  ...
  // Check on scroll
  scrollDiv.addEventListener("scroll", checkPosition);

  // Check on resize (content might change)
  window.addEventListener("resize", checkPosition);

  // Make functions globally available
  window.scrollLft = function () {
    if (!leftBtn.disabled) {
      scrollDiv.scrollBy({
        left: -scrollAmount,
        behavior: "smooth",
