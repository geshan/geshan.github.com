...
if (scrollDiv) {
  ...
  const checkPosition = () =>{
    isInViewport(firstTag) ? leftBtn.style.display = 'none' : leftBtn.style.display = 'block';
    isInViewport(lastTag) ? rightBtn.style.display = 'none' : rightBtn.style.display = 'block';
  }
  checkPosition();
  function scrollLft() {
