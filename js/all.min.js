...
function toggleNavBar() { var navbar = document.getElementById("navbar-links");(navbar.style.display === "grid") ? navbar.style.display = "none" : navbar.style.display = "grid";}

/*! echo-js v1.7.3 | (c) 2016 @toddmotto | https://github.com/toddmotto/echo */ !function(t,e){"function"==typeof define&&define.amd?define(function(){return e(t)}):"object"==typeof exports?module.exports=e:t.echo=e(t)}(this,function(t){"use strict";var e,n,o,r,c,a={},u=function(){},d=function(t){return null===t.offsetParent},l=function(t,e){if(d(t))return!1;var n=t.getBoundingClientRect();return n.right>=e.l&&n.bottom>=e.t&&n.left<=e.r&&n.top<=e.b},i=function(){(r||!n)&&(clearTimeout(n),n=setTimeout(function(){a.render(),n=null},o))};return a.init=function(n){n=n||{};var d=n.offset||0,l=n.offsetVertical||d,f=n.offsetHorizontal||d,s=function(t,e){return parseInt(t||e,10)};e={t:s(n.offsetTop,l),b:s(n.offsetBottom,l),l:s(n.offsetLeft,f),r:s(n.offsetRight,f)},o=s(n.throttle,250),r=n.debounce!==!1,c=!!n.unload,u=n.callback||u,a.render(),document.addEventListener?(t.addEventListener("scroll",i,!1),t.addEventListener("load",i,!1)):(t.attachEvent("onscroll",i),t.attachEvent("onload",i))},a.render=function(n){for(var o,r,d=(n||document).querySelectorAll("[data-echo], [data-echo-background]"),i=d.length,f={l:0-e.l,t:0-e.t,b:(t.innerHeight||document.documentElement.clientHeight)+e.b,r:(t.innerWidth||document.documentElement.clientWidth)+e.r},s=0;i>s;s++)r=d[s],l(r,f)?(c&&r.setAttribute("data-echo-placeholder",r.src),null!==r.getAttribute("data-echo-background")?r.style.backgroundImage="url("+r.getAttribute("data-echo-background")+")":r.src!==(o=r.getAttribute("data-echo"))&&(r.src=o),c||(r.removeAttribute("data-echo"),r.removeAttribute("data-echo-background")),u(r,"load")):c&&(o=r.getAttribute("data-echo-placeholder"))&&(null!==r.getAttribute("data-echo-background")?r.style.backgroundImage="url("+o+")":r.src=o,r.removeAttribute("data-echo-placeholder"),u(r,"unload"));i||a.detach()},a.detach=function(){document.removeEventListener?t.removeEventListener("scroll",i):t.detachEvent("onscroll",i),clearTimeout(n)},a});echo.init({ callback: function (element, op) { //console.log(element, 'has been', op + 'ed'); 
} });
// echo.render(); is also available for non-scroll callbacks

/* font awesome */
window.FontAwesomeKitConfig = {"asyncLoading":{"enabled":false},"autoA11y":{"enabled":true},"baseUrl":"https://ka-f.fontawesome.com","detectConflictsUntil":null,"iconUploads":{},"license":"free","method":"css","minify":{"enabled":true},"token":"140bae2d75","v4FontFaceShim":{"enabled":true},"v4shim":{"enabled":true},"version":"5.15.1"};
...
/* load disqus */
window.load_disqus=function(){const e=document.getElementById("disqus_trigger"),t=document.getElementById("disqus_thread"),d=document.createElement("script"),s=document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0];t&&e?(d.type="text/javascript",d.async=!0,d.src="//geshanblog.disqus.com/embed.js",s.appendChild(d),e.remove()):console.error("Could not load disqus comments because target or trigger is not defined.")};

/* copy to clipboard */
function addCopyButtons(r){document.querySelectorAll("pre > code").forEach(function(e){var t=document.createElement("button");t.className="copy-code-button",t.type="button",t.setAttribute('title',"Copy"),t.addEventListener("click",function(){r.writeText(e.innerText).then(function(){t.classList.add('copied'),setTimeout(function(){t.classList.remove('copied')},1000)},function(e){t.innerText="Error"})});var n,o=e.parentNode;o.parentNode.classList.contains("highlight")?(n=o.parentNode).parentNode.insertBefore(t,n):o.parentNode.insertBefore(t,o)})}
var script;navigator&&navigator.clipboard?addCopyButtons(navigator.clipboard):((script=document.createElement("script")).src="https://cdnjs.cloudflare.com/ajax/libs/clipboard-polyfill/2.7.0/clipboard-polyfill.promise.js",script.integrity="sha256-waClS2re9NUbXRsryKoof+F9qc1gjjIhc2eT7ZbIv94=",script.crossOrigin="anonymous",script.onload=function(){addCopyButtons(clipboard)},document.body.appendChild(script));
...
/* Table of contents */
if(document.querySelector('h2#table-of-contents')){
  const tableOfContents = document.querySelector('h2#table-of-contents').nextElementSibling;
const contentLayout = `
<details>
<summary>Click to expand!</summary>
<ol>${tableOfContents.innerHTML}</ol>
</details>
`
const list = document.createElement('div');
list.innerHTML = contentLayout;
tableOfContents.parentNode.replaceChild(list, tableOfContents);
}

/* Tags scroll */
const scrollDiv =  document.querySelector('ul#scrollDiv');
const leftBtn = document.querySelector('button#leftBtn');
const rightBtn = document.querySelector('button#rightBtn');
if (scrollDiv) {
  const lastTag = scrollDiv.lastChild;
  const firstTag = scrollDiv.firstChild;
  let style = window.getComputedStyle(scrollDiv);
  let left = style.getPropertyValue('left');
  function isInViewport(element) {
    const tag = element.getBoundingClientRect();
    return (
        tag.left >= 0 &&
        tag.right <= (window.innerWidth)
    );
  }
  const checkPosition = () =>{
    isInViewport(firstTag) ? leftBtn.disabled = true : leftBtn.disabled= false;
    isInViewport(lastTag) ? rightBtn.disabled = true : rightBtn.disabled= false;
  }
  checkPosition();
  function scrollLft() {
    scrollDiv.style.left = parseInt(left, 10) + 700 + "px"
    left = scrollDiv.style.left;
    checkPosition();
  }
